...
- 2026-06-20: Follow-up v0.4.54 fixed user feedback: translated reports now remember Chinese display mode across dossier reopens, the model pill switches to the translation model/provider while translated, and partial review caches show `cached / listed` with a direct in-dossier `Fetch more reviews` action.
