...
(function () {
  ...
  const messages = {
    en: {
      'skip': 'Skip to main content', 'auto': 'Auto', 'tagline': 'Read hundreds of reviews before you walk in. Walk in armed.', 'nav.scout': 'Scout', 'nav.shop': 'Shop', 'nav.library': 'Library', 'nav.ask': 'Ask cache',
      ...
      'reason.empty': 'Scout searches or refreshes Google Maps and review evidence. Ask only uses cached evidence.', 'reason.maps': 'Maps link detected. Shop is the fastest path.', 'reason.ask': 'Ask uses cached evidence and will not discover new Google Maps places.', 'reason.shopname': 'This looks like a specific shop name. Shop is recommended.', 'reason.scout': 'Scout searches or refreshes Google Maps and review evidence before generating a report.', 'reason.selected': 'Selected {mode}.', 'advanced': 'Advanced', 'refresh': 'Force refresh cache', 'noai': 'Disable AI planning',
      ...
      'ph.query': 'Shop / need / Maps URL, any language\nExample: guitar lessons Da Nang...', 'ph.near': 'Example: Hoi An, Vietnam...', 'ph.shop': 'Example: The Workshop Coffee or a Google Maps link...', 'ph.ask': 'Example: Which teacher is most patient? Any red flags?...', 'ph.model': 'Example: gemini-flash-latest...', 'ph.library': 'Example: guitar / hiking / Hoi An...', 'goto.scout': 'Go to Scout →', 'loading.library': 'Reading Library', 'empty.library': 'Library is empty. Run your first Scout.', 'empty.library.nomatch': 'No shops match. Try another keyword.', 'empty.history': 'No searches yet.', 'filter.sort.smart': 'Smart sort', 'filter.sort.fresh': 'Recently updated', 'filter.sort.cached': 'Most cached reviews', 'filter.sort.rating': 'Highest rating', 'filter.category.all': 'All categories', 'filter.freshness.all': 'All freshness', 'filter.freshness.recent': 'Recently updated', 'filter.freshness.stale': 'Possibly stale', 'filter.risk.all': 'All risk levels', 'filter.risk.risk': 'Needs verification', 'filter.risk.ok': 'Hide risk flags', 'filter.language.all': 'All languages', 'filter.language.zh': 'Chinese', 'filter.language.en': 'English', 'filter.language.vi': 'Vietnamese', 'filter.language.ko': 'Korean', 'filter.language.other': 'Other', 'filter.cached.all': 'All cache sizes', 'filter.cached.50': '50+ cached', 'filter.cached.100': '100+ cached', 'filter.cached.300': '300+ cached', 'filter.report.all': 'All reports', 'filter.report.with': 'Has report', 'filter.report.no': 'No report', 'aria.library.sort': 'Sort Library', 'aria.library.category': 'Filter by category', 'aria.library.freshness': 'Filter by freshness', 'aria.library.risk': 'Filter by risk', 'aria.library.language': 'Filter by review language', 'aria.library.cached': 'Filter by cached review count', 'aria.library.report': 'Filter by report'
    },
    zh: {
      'skip': '跳到主要内容', 'auto': '自动', 'tagline': '进店之前，先读完它的几百条评价。带着情报进店。', 'nav.scout': '侦察新店', 'nav.shop': '单店深挖', 'nav.library': '资料库', 'nav.ask': '问缓存',
      'label.query': '想找什么', 'label.near': '在哪里', 'label.profile': '报告类型', 'label.top': '深挖几家', 'label.max': '每家最多评价数', 'label.target': '哪家店',
      'mode.scout': '侦察新店', 'mode.shop': '单店深挖', 'mode.ask': '问缓存', 'mode.help.scout': '搜地图并抓评价', 'mode.help.shop': '已知店名或链接', 'mode.help.ask': '只问已有证据',
      'reason.empty': '侦察会搜索或刷新地图与评价证据；问缓存只使用已有证据。', 'reason.maps': '检测到地图链接，建议走单店深挖。', 'reason.ask': '问缓存只使用已有证据，不会发现新的地图店铺。', 'reason.shopname': '这看起来像具体店名，建议走单店深挖。', 'reason.scout': '侦察会先搜索或刷新地图与评价证据，再生成报告。', 'reason.selected': '已选择{mode}。', 'advanced': '高级', 'refresh': '强制刷新缓存', 'noai': '关闭 AI 规划',
      'button.scout': '开始侦察 →', 'button.shop': '深挖这家店 →', 'button.ask': '问缓存 →', 'hint.scout': '第一次跑新地点需要几分钟：AI 规划、搜索、AI 筛选、抓评价、向量化、推理报告。全程进度都看得见。',
      'hint.shop': '结果是一份聚焦报告：这家店的口碑、反复出现的抱怨、防坑要点。', 'hint.ask': '问缓存只问已有证据，不搜索地图。要找新地方或刷新评价，先跑侦察或单店深挖。',
      'past.scouts': '已侦察', 'refresh.short': '刷新 ↻', 'live': '实时进度', 'cached.shops': '已缓存的店', 'past.searches': '历史搜索', 'ask.label': '问缓存里的所有评价',
      'footer': 'placeintel · 本地评价情报站 · 数据只缓存在本机', 'system': '系统', 'model.switch': '更换模型 ⇄', 'model.save': '保存',
      'detail.title': '店铺档案', 'detail.close': '关闭', 'photo.label': '来源图片', 'noscript': 'placeintel 需要启用 JavaScript 才能工作。',
      'ph.query': '店名 / 需求 / 地图链接，任何语言\n例：会安吉他租赁…', 'ph.near': '例：会安，越南…', 'ph.shop': '例：某家咖啡店或地图链接…', 'ph.ask': '例：哪家老师最有耐心？哪家有坑？…', 'ph.model': '例：gemini-flash-latest…', 'ph.library': '例：吉他 / 徒步 / 会安…', 'goto.scout': '去侦察 →', 'loading.library': '读取资料库', 'empty.library': '资料库是空的，先跑第一次侦察。', 'empty.library.nomatch': '没有匹配的店，换个关键词。', 'empty.history': '还没有搜索记录。', 'filter.sort.smart': '智能排序', 'filter.sort.fresh': '最近更新', 'filter.sort.cached': '缓存评价多', 'filter.sort.rating': '评分高', 'filter.category.all': '全部类别', 'filter.freshness.all': '全部新鲜度', 'filter.freshness.recent': '近期更新', 'filter.freshness.stale': '可能过期', 'filter.risk.all': '全部风险', 'filter.risk.risk': '只看需核实', 'filter.risk.ok': '隐藏风险项', 'filter.language.all': '全部语言', 'filter.language.zh': '中文', 'filter.language.en': '英语', 'filter.language.vi': '越南语', 'filter.language.ko': '韩语', 'filter.language.other': '其他', 'filter.cached.all': '全部缓存', 'filter.cached.50': '50+ 已缓存', 'filter.cached.100': '100+ 已缓存', 'filter.cached.300': '300+ 已缓存', 'filter.report.all': '全部报告', 'filter.report.with': '有报告', 'filter.report.no': '无报告', 'aria.library.sort': '资料库排序', 'aria.library.category': '按类别筛选', 'aria.library.freshness': '按新鲜度筛选', 'aria.library.risk': '按风险筛选', 'aria.library.language': '按评价语言筛选', 'aria.library.cached': '按缓存评价数筛选', 'aria.library.report': '按报告筛选'
    },
  };
  const stageLabels = {
    en: { plan: 'plan', search: 'search', filter: 'filter', reviews: 'reviews', embed: 'embed', report: 'report', done: 'done' },
    zh: { plan: 'AI规划', search: '搜索', filter: 'AI筛选', reviews: '抓评价', embed: '向量化', report: '推理报告', done: '完成' },
  };
  ...
  const langMetaMap = { en: { zh: ['Chinese', '', 'Chinese-language reviews'], en: ['English', '', 'English-language reviews'], vi: ['Vietnamese', '', 'Vietnamese-language reviews'], fr: ['French', '', 'French-language reviews'], es: ['Spanish', '', 'Spanish-language reviews'], de: ['German', '', 'German-language reviews'], ko: ['Korean', '', 'Korean-language reviews'], ja: ['Japanese', '', 'Japanese-language reviews'], th: ['Thai', '', 'Thai-language reviews'], other: ['Other', '', 'Mixed language'], unknown: ['No text', '', 'Rating-only'] }, zh: { zh: ['中文', '', '中文评价'], en: ['英语', '', '英语评价'], vi: ['越南语', '', '越南语评价'], fr: ['法语', '', '法语评价'], es: ['西班牙语', '', '西班牙语评价'], de: ['德语', '', '德语评价'], ko: ['韩语', '', '韩语评价'], ja: ['日语', '', '日语评价'], th: ['泰语', '', '泰语评价'], other: ['其他', '', '混合语言'], unknown: ['无文字', '', '仅评分'] } };
  const langOrder = ['zh', 'en', 'vi', 'ko', 'ja', 'th', 'other', 'unknown'];
  const ratingFilters = [['all', '全部评分', 'All ratings'], ['5', '5★', '5★'], ['4', '4★', '4★'], ['low', '≤3★', '≤3★']];
  ...
  function pick(zh, en) { return activeUi() === 'zh' ? zh : en; }
  ...
  function languageOptionsHtml(selected, includeAuto = false) { const opts = includeAuto ? ['auto', ...commonTargets] : commonTargets; return opts.map((tag) => `<option value="${tag}"${selected === tag ? ' selected' : ''}>${tag === 'auto' ? t('auto') : (langMeta(tag)[0] || labels[tag] || tag)}</option>`).join(''); }
  function stageLabel(stage) { return (stageLabels[activeUi()] || stageLabels.en)[stage] || stage || '...'; }
  function langMeta(code) { const table = langMetaMap[activeUi()] || langMetaMap.en; return table[code] || table.other; }
  ...
  window.PI18N = { supportedUiLocales, init, applyConfig: init, applyStaticText, t, pick, normalizeTag, browserTag, state, savePrefs, requestPayload, outputLanguage, translationTarget, labels, languageOptionsHtml, relTime, fmtClock, fmtInt, stageLabel, langMeta, reviewBody, detectReviewLang, reviewThemes, reviewRatingBand, languageGroups, ratingFilters };
}());
